...
const Modal = (props) => {
    ...
    return (
        <div onClick={handleClickOutside} className="fixed  inset-0 flex items-center justify-center p-2 z-50">
            <motion.div
                ref={modalRef}
                className="w-full relative rounded-xl modalClass transition-colors duration-500 max-w-[90%] h-[70%] lg:max-w-[80%] max-h-full bg-white py-6 px-4 lg:p-12 xl:p-24 overflow-y-auto"
