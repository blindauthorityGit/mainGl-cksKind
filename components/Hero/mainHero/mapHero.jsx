...
const MapHero = ({ data, bgColor, modal, onClick, noCards, klasse }) => {
    ...
    return (
        <section
            ...
            className={`${klasse} col-span-12 min-h-[95vh] xl:min-h-0  bg-[#AFD3A2] md:bg-transparent md:px-4 pb-8 lg:pb-0 lg:mt-24`}
        >
