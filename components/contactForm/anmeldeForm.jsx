...
const AnmeldeForm = ({ data, children, events }) => {
    ...
    return (
        <MainContainer width=" sm:pt-4 sm:pb-0  relative ">
            <div className="col-span-12 xl:col-span-6  grid grid-cols-12 ">
                ...
                >
                    ...
                    <input
                        ...
                        placeholder="Telefon"
                    />
                    {errors.phone && <Error>Bitte geben Sie Ihre Telefonnummer an</Error>}
            ...
            <div className="col-span-6">
                <Calendar data={Array.isArray(events) ? events : [events]}></Calendar>
            </div>
