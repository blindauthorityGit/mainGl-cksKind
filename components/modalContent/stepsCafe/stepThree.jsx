  ...
  return (
    <div className="flex-grow xl:w-2/4">
      ...
      <div className="wrapper mb-4">
        <P><strong>Datum:</strong> {formData.date.toLocaleDateString("de-DE")}</P>
        <P><strong>Zeitfenster:</strong> {formData.timeSlot}</P>
        <P><strong>Anzahl der Erwachsenen:</strong> {formData.guests}</P>
        <P><strong>Anzahl der Kinder:</strong> {formData.kids}</P>
      </div>
      ...
      <div className="grid grid-cols-6 gap-4 mb-4">
        ...
        <div className="col-span-6">
          <input
            ...
            placeholder="Telefon"
            className={`w-full text-xs 2xl:text-base border-2 rounded-full p-2 sm:p-4 ${errors.telefon ? 'border-red-500' : 'border-textColor'} bg-transparent text-textColor placeholder-primaryColor-950`}
            required
          />
        ...
        <div className="col-span-6">
          <input
            ...
            placeholder="E-Mail"
            className={`w-full text-xs 2xl:text-base border-2 rounded-full p-2 sm:p-4 ${errors.email ? 'border-red-500' : 'border-textColor'} bg-transparent text-textColor placeholder-primaryColor-950`}
            required
          />
